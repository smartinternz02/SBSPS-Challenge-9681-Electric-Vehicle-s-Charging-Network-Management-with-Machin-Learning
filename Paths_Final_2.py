...
print("\nPath Taken",path_optimal)
print("\nBattery charge Matrix",batc_optimal)
print("\nTime charging starts of car i at node j\n",charge_start_time)
print("\nTime charging ends of car i at node j\n",charge_end_time)
print("\nTime when Car i leaves nodes in its path\n",time_optimal)
print("\nMaximum of the time\n",minimum_time_achieved)